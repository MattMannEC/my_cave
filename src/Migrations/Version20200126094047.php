...
final class Version20200126094047 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE wine CHANGE name name VARCHAR(255) NOT NULL, CHANGE vintage vintage VARCHAR(4) DEFAULT NULL, CHANGE grape grape VARCHAR(255) DEFAULT NULL, CHANGE country country VARCHAR(255) DEFAULT NULL, CHANGE region region VARCHAR(255) DEFAULT NULL, CHANGE description description VARCHAR(255) DEFAULT NULL, CHANGE ref_image ref_image VARCHAR(255) DEFAULT NULL');
    }
